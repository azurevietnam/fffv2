        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-lg-4 col-xs-12">
                        <div class="white-box">
                            <div class="user-bg"> <img src="{{url('/')}}/plugins/images/large/img1.jpg" alt="user" style="100%">
                                <div class="overlay-box">
                                    <div class="user-content">
                                        <a href="javascript:void(0)"><img alt="img" class="thumb-lg img-circle" src="{{url('/')}}/plugins/images/users/genu.jpg"></a>
