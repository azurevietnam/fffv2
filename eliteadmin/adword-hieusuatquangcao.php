            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">HIỆU XUẤT QUẢNG CÁO</h4> </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">CHIẾN DỊCH ADWORDS</h3>
                            <p class="text-muted m-b-20">Bạn có thể tạm ngưng chiến dịch ngay lập tức nếu phát hiện click tặc quá nhiều. Hoăc <a href="">Cấu Hình Chặn Tự Động</a></p>
