 ...
 */
	...
	$smtp->host_name="in-v3.mailjet.com"; //IP address       /* Change this variable to the address of the SMTP server to relay, like "smtp.myisp.com" */
	...
	$smtp->user="6d733c3d4223e7bb5967378b7bc07f6c";                     /* Set to the user name if the server requires authetication */
	$smtp->realm="";                    /* Set to the authetication realm, usually the authentication user e-mail domain */
	$smtp->password="c0d05f3bc798e9ed0051d30a88216bc4";                 /* Set to the authetication password */
